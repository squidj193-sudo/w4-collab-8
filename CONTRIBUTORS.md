...
| 角色 | 姓名 | 負責分支 | 任務 | 狀態 |
|------|------|---------|------|------|
| 組長 | 江庭翔| `main` | 修改標題 & header 顏色 | ✔️ |
| 組員 A | 黃元稜| `feature/member-a` | 修改使用者訊息顏色 & 加計數器 | ✔️ |
| 組員 B | 葉書愷 | `feature/member-b` | 修改按鈕樣式 & 加 footer 名單 | ✔️ |
| 組員 C | 吳東霖| `feature/member-c` | 加入歡迎訊息 & 自訂回覆邏輯 | ✔️ |
| 組員 D | 吳東霖| `feature/member-d` | 加入深色模式切換按鈕 | ✔️ |
| 組員 E | 吳東霖| `feature/member-e` | 加入清除對話功能 | ✔️ |
